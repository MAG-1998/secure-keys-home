...
-- Migrate existing role data from user_roles to profiles (if user_roles table exists)
DO $$
BEGIN
...
-- Create assignRole function to update profiles.role
...
-- Drop the user_roles table as it's no longer needed (if it exists)
