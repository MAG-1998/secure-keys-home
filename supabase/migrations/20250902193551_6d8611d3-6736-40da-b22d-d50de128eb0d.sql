-- Enhanced Halal Financing Workflow Schema Updates (RLS Fix)
...
-- Drop the existing policy that uses the stage column
DROP POLICY IF EXISTS "Users can delete their own unassigned halal financing requests" ON public.halal_financing_requests;
