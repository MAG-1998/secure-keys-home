...
const translations: Translations = {
  ...
  'listProperty.premiumExposure': {
    en: 'Premium Exposure',
    ru: 'Премиальная экпозиция',
    uz: 'Premium namoyish'
  },
  'listProperty.halalServiceFee': {
    en: '⚠️ Please note: Enabling Halal financing includes up to a 2% service fee for facilitating Sharia-compliant transactions.',
    ru: '⚠️ Обратите внимание: Включение халяльного финансирования включает до 2% комиссии за проведение транзакций, соответствующих шариату.',
    uz: '⚠️ Eslatma: Halol moliyalashtirishni yoqish shariatga mos tranzaksiyalarni amalga oshirish uchun 2% gacha xizmat to\'lovini o\'z ichiga oladi.'
  },
  ...
  'listProperty.halalServiceFeeLabel': {
    en: 'Halal Service Fee (2%):',
    ru: 'Комиссия за халяльное финансирование (2%):',
    uz: 'Halol xizmat to\'lovi (2%):'
  },
  ...
  'listProperty.magitCoversFee': {
    en: 'When you enable halal financing, Magit covers the 1% transaction fee to make your property accessible to Islamic finance buyers.',
    ru: 'Когда вы включаете халяльное финансирование, Magit покрывает комиссию в размере 1%, чтобы сделать вашу недвижимость доступной для покупателей исламского финансирования.',
    uz: 'Halol moliyalashtirishni yoqganingizda, Magit islom moliya xaridorlari uchun mulkingizni mavjud qilish uchun 1% tranzaksiya to\'lovini qoplaydi.'
  },
  'listProperty.reviewAndSubmit': {
    en: 'Review & Submit',
    ru: 'Проверка и отправка',
    uz: 'Ko\'rib chiqish va yuborish'
  },
  ...
  'listProperty.displayPhoneNumber': {
    en: 'Display my phone number on this listing',
    ru: 'Показывать мой номер телефона в этом объявлении',
    uz: 'Bu e\'londa telefon raqamimni ko\'rsatish'
  },
  'listProperty.phoneNumberVisibility': {
    en: 'Your phone number will be visible to all users viewing this property. If unchecked, buyers will see: "Seller prefers to be contacted via messages"',
    ru: 'Ваш номер телефона будет виден всем пользователям, просматривающим это объявление. Если не отмечено, покупатели увидят: "Продавец предпочитает связь через сообщения"',
    uz: 'Telefon raqamingiz ushbu mulkni ko\'radigan barcha foydalanuvchilarga ko\'rinadi. Agar belgilanmagan bo\'lsa, xaridorlar ko\'radilar: "Sotuvchi xabarlar orqali aloqa qilishni afzal ko\'radi"'
  },
  'listProperty.phoneDisplay': {
    en: 'Phone Display:',
    ru: 'Отображение телефона:',
    uz: 'Telefon ko\'rinishi:'
  },
  'listProperty.enabled': {
    en: 'Enabled ✓',
    ru: 'Включено ✓',
    uz: 'Yoqilgan ✓'
  },
  'listProperty.dragPhotosToReorder': {
    en: 'Drag photos to reorder • {count}/20 photos',
    ru: 'Перетащите фотографии для сортировки • {count}/20 фото',
    uz: 'Rasmlarni tartiblash uchun torting • {count}/20 rasm'
  },
  'listProperty.lateNightWarning': {
    en: '⚠️ Late night/early morning hours may be inconvenient for visitors. Consider offering daytime hours as well.',
    ru: '⚠️ Поздние ночные/ранние утренние часы могут быть неудобными для посетителей. Рассмотрите также предложение дневных часов.',
    uz: '⚠️ Kechki/erta tonggi soatlar tashrif buyuruvchilar uchun noqulay bo\'lishi mumkin. Kunduzgi soatlarni ham taklif qilishni o\'ylab ko\'ring.'
  },
  'listProperty.photosRequired': {
    en: 'Photos Required',
    ru: 'Фотографии обязательны',
    uz: 'Rasmlar talab qilinadi'
  },
  'listProperty.uploadAtLeast5Photos': {
    en: 'Please upload at least 5 photos before proceeding.',
    ru: 'Пожалуйста, загрузите хотя бы 5 фотографий перед продолжением.',
    uz: 'Davom etishdan oldin kamida 5 ta rasm yuklang.'
  },
  'listProperty.draftCleared': {
    en: 'Draft cleared',
    ru: 'Черновик очищен',
    uz: 'Qoralama tozalandi'
  },
  'listProperty.formReset': {
    en: 'Form has been reset to empty state.',
    ru: 'Форма была сброшена до пустого состояния.',
    uz: 'Forma bo\'sh holatga qaytarildi.'
  },
  'listProperty.draftSaved': {
    en: 'Draft saved',
    ru: 'Черновик сохранён',
    uz: 'Qoralama saqlandi'
  },
  'listProperty.progressSaved': {
    en: 'Your progress has been saved.',
    ru: 'Ваш прогресс сохранён.',
    uz: 'Progressingiz saqlandi.'
  },
  'listProperty.tooManyPhotos': {
    en: 'Too many photos',
    ru: 'Слишком много фотографий',
    uz: 'Juda ko\'p rasmlar'
  },
  'listProperty.maxPhotosWarning': {
    en: 'Maximum is 20 photos. Keeping the first 20.',
    ru: 'Максимум 20 фотографий. Сохраняем первые 20.',
    uz: 'Maksimum 20 ta rasm. Birinchi 20 tasini saqlaymiz.'
  },
  'listProperty.photosConverted': {
    en: 'Photos converted',
    ru: 'Фотографии конвертированы',
    uz: 'Rasmlar konvertatsiya qilindi'
  },
  'listProperty.photosConvertedCount': {
    en: '{count} photo(s) converted to JPEG format.',
    ru: '{count} фото конвертировано в формат JPEG.',
    uz: '{count} ta rasm JPEG formatiga konvertatsiya qilindi.'
  },
  'listProperty.conversionFailed': {
    en: 'Conversion failed',
    ru: 'Конвертация не удалась',
    uz: 'Konvertatsiya amalga oshmadi'
  },
  'listProperty.conversionFailedDescription': {
    en: 'Some photos could not be converted. Please try again.',
    ru: 'Некоторые фотографии не удалось конвертировать. Пожалуйста, попробуйте ещё раз.',
    uz: 'Ba\'zi rasmlar konvertatsiya qilinmadi. Iltimos, qayta urinib ko\'ring.'
  },
  'listProperty.applicationSubmittedSuccess': {
    en: 'Your property application has been submitted for review',
    ru: 'Ваша заявка на недвижимость отправлена на проверку',
    uz: 'Mulkingiz bo\'yicha arizangiz ko\'rib chiqish uchun yuborildi'
  },
  'listProperty.applicationAndFinancingSubmitted': {
    en: 'Your property application and halal financing request have been submitted for review',
    ru: 'Ваша заявка на недвижимость и запрос на халяльное финансирование отправлены на проверку',
    uz: 'Mulkingiz bo\'yicha ariza va halol moliyalashtirish so\'rovi ko\'rib chiqish uchun yuborildi'
  },
  'listProperty.submissionFailed': {
    en: 'Failed to submit application. Please try again.',
    ru: 'Не удалось отправить заявку. Пожалуйста, попробуйте ещё раз.',
    uz: 'Arizani yuborib bo\'lmadi. Iltimos, qayta urinib ko\'ring.'
  },
  'listProperty.validatingInformation': {
    en: 'Validating information',
    ru: 'Проверка информации',
    uz: 'Ma\'lumotlarni tekshirish'
  },
  'listProperty.creatingListing': {
    en: 'Creating property listing',
    ru: 'Создание объявления о недвижимости',
    uz: 'Mulk e\'lonini yaratish'
  },
  'listProperty.uploadingPhotos': {
    en: 'Uploading photos',
    ru: 'Загрузка фотографий',
    uz: 'Rasmlar yuklanmoqda'
  },
  'listProperty.uploadingPhotoCount': {
    en: 'Uploading photo {current} of {total}',
    ru: 'Загрузка фото {current} из {total}',
    uz: 'Rasm yuklanmoqda {current} / {total}'
  },
  'listProperty.updatingDetails': {
    en: 'Updating property details',
    ru: 'Обновление деталей недвижимости',
    uz: 'Mulk tafsilotlari yangilanmoqda'
  },
  'listProperty.settingUpFinancing': {
    en: 'Setting up halal financing',
    ru: 'Настройка халяльного финансирования',
    uz: 'Halol moliyalashtirishni sozlash'
  },
  'listProperty.finalizingSubmission': {
    en: 'Finalizing submission',
    ru: 'Завершение отправки',
    uz: 'Yuborishni yakunlash'
  },
