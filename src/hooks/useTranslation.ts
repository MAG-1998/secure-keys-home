...
const translations: Translations = {
  ...
  'pageTitle.savedProperties': {
    en: 'Saved Properties',
    ru: 'Сохранённые объекты',
    uz: 'Saqlangan uylar'
  },
  'pageTitle.myRequests': {
    en: 'My Requests',
    ru: 'Мои заявки',
    uz: 'Mening so\'rovlarim'
  },
  'pageTitle.myFinancing': {
    en: 'My Financing',
    ru: 'Мое финансирование',
    uz: 'Mening moliyalashtirish'
  },
